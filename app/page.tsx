...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      {/* Hero Section */}
      <main className="relative z-10 flex items-center min-h-screen px-6 sm:px-8 pt-20">
            ...
            <div className="flex-1">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-300 text-xl leading-relaxed">
                  passionate about crafting seamless user experiences I thrive at the intersection<br />
              ...
              <div className="flex items-center gap-4">
                <button className="flex items-center space-x-2 bg-black/30 hover:bg-black/40 text-white px-5 py-2.5 rounded-md border border-gray-600/30 transition-all duration-300">
